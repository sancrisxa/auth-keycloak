package com.sancrisxa.app_auth_youtube.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
        ...
        formData.add("grant_type", user.granType);
    ...
    public record User(String password, String clientId, String granType, String username) {}
}
